"""
Django settings for enterplatform project.
...
SECRET_KEY = 'django-insecure-cd$ufg5l6ebc7iqo!d%s0v0@o3abyd4s1icsy6t6=)sw8@26y@'
...
ROOT_URLCONF = 'enterplatform.urls'
...
WSGI_APPLICATION = 'enterplatform.wsgi.application'
